...
function DetailAnime() {
  ...
  return (
    <div className="container mx-auto max-w-full">
      ...
      <header className="flex flex-col md:flex-row md:text-left md:items-center md:justify-start md:px-20 md:pt-52 text-center items-center gap-6 justify-center pt-40">
        <Zoom className="">
          <img
